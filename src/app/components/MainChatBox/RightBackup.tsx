            ...
            <div className="simplebar-wrapper m-0">
                ...
                <div className="simplebar-mask">
                    <div className="simplebar-offset right-0 bottom-0">
                        <div className="simplebar-content-wrapper h-full overflow-['hidden scroll']" tabIndex="0" role="region"
                                    ...
                                    <span className="icon unmuted-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <path
                                                ...
                                                <span className="icon muted-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                         fill="currentColor" className="bi bi-bell-slash-fill"
                                                         viewBox="0 0 16 16">
                                        ...
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" data-bs-toggle="tab"
                                                    data-bs-target="#chat-media" type="button" aria-selected="false"
                                                    tabIndex="-1" role="tab">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link active" data-bs-toggle="tab"
                                                    data-bs-target="#chat-options" type="button" aria-selected="true"
                                                    role="tab">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <div className="tab-pane" id="chat-media" tabIndex="0" role="tabpanel">
                                        <div className="tyn-aside-row py-0">
                                            <ul className="nav nav-tabs nav-tabs-line" role="tablist">
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link active" data-bs-toggle="tab"
                                                            data-bs-target="#chat-media-images" type="button"
                                                            aria-selected="true" role="tab"> Images
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" data-bs-toggle="tab"
                                                            data-bs-target="#chat-media-videos" type="button"
                                                            aria-selected="false" tabIndex="-1" role="tab"> Videos
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" data-bs-toggle="tab"
                                                            data-bs-target="#chat-media-files" type="button"
                                                            aria-selected="false" tabIndex="-1" role="tab"> Files
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" data-bs-toggle="tab"
                                                            data-bs-target="#chat-media-links" type="button"
                                                            aria-selected="false" tabIndex="-1" role="tab"> Links
                                                    </button>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div className="tab-content">
                                                <div className="tab-pane show active" id="chat-media-images"
                                                    ...
                                                    <div className="row g-3">
                                                        <div className="col-4">
                                                            <a href="assets/images/gallery/chat/1.jpg"
                                                               className="glightbox tyn-thumb"
                                                               data-gallery="media-photo">
                                                                <img src="assets/images/gallery/chat/thumb-1.jpg"
                                                                     className="tyn-image" alt=""/>
                                                            </a>
                                                        </div>
                                                        <div className="col-4">
                                                            <a href="assets/images/gallery/chat/2.jpg"
                                                               className="glightbox tyn-thumb"
                                                               data-gallery="media-photo">
                                                                <img src="assets/images/gallery/chat/thumb-2.jpg"
                                                                     className="tyn-image" alt=""/>
                                                            </a>
                                                        </div>
                                                        <div className="col-4">
                                                            <a href="assets/images/gallery/chat/3.jpg"
                                                               className="glightbox tyn-thumb"
                                                               data-gallery="media-photo">
                                                                <img src="assets/images/gallery/chat/thumb-3.jpg"
                                                                     className="tyn-image" alt=""/>
                                                            </a>
                                                        </div>
                                                        <div className="col-4">
                                                            <a href="assets/images/gallery/chat/4.jpg"
                                                               className="glightbox tyn-thumb"
                                                               data-gallery="media-photo">
                                                                <img src="assets/images/gallery/chat/thumb-4.jpg"
                                                                     className="tyn-image" alt=""/>
                                                            </a>
                                                        </div>
                                                        <div className="col-4">
                                                            <a href="assets/images/gallery/chat/5.jpg"
                                                               className="glightbox tyn-thumb"
                                                               data-gallery="media-photo">
                                                                <img src="assets/images/gallery/chat/thumb-5.jpg"
                                                                     className="tyn-image" alt=""/>
                                                            </a>
                                                        </div>
                                                        <div className="col-4">
                                                            <a href="assets/images/gallery/chat/6.jpg"
                                                               className="glightbox tyn-thumb"
                                                               data-gallery="media-photo">
                                                                <img src="assets/images/gallery/chat/thumb-6.jpg"
                                                                     className="tyn-image" alt=""/>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="row g-3">
                                                        <div className="col-6">
                                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8"
                                                               ...
                                                               data-gallery="media-video">
                                                                <img src="assets/images/gallery/video/hr-1.jpg"
                                                                     className="tyn-image" alt=""/>
                                                        ...
                                                        <div className="col-6">
                                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8"
                                                               className="glightbox tyn-video"
                                                               data-gallery="media-video">
                                                                <img src="assets/images/gallery/video/hr-2.jpg"
                                                                     className="tyn-image" alt=""/>
                                                                <div className="tyn-video-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         width="16" height="16" fill="currentColor"
                                                        ...
                                                        <div className="col-6">
                                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8"
                                                               className="glightbox tyn-video"
                                                               data-gallery="media-video">
                                                                <img src="assets/images/gallery/video/hr-3.jpg"
                                                                     className="tyn-image" alt=""/>
                                                                <div className="tyn-video-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         width="16" height="16" fill="currentColor"
                                                        ...
                                                        <div className="col-6">
                                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8"
                                                               className="glightbox tyn-video"
                                                               data-gallery="media-video">
                                                                <img src="assets/images/gallery/video/hr-4.jpg"
                                                                     className="tyn-image" alt=""/>
                                                                <div className="tyn-video-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         width="16" height="16" fill="currentColor"
                                                        ...
                                                        <div className="col-6">
                                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8"
                                                               className="glightbox tyn-video"
                                                               data-gallery="media-video">
                                                                <img src="assets/images/gallery/video/vr-5.jpg"
                                                                     className="tyn-image" alt=""/>
                                                                <div className="tyn-video-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         width="16" height="16" fill="currentColor"
                                                        ...
                                                        <div className="col-6">
                                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8"
                                                               className="glightbox tyn-video"
                                                               data-gallery="media-video">
                                                                <img src="assets/images/gallery/video/hr-6.jpg"
                                                                     className="tyn-image" alt=""/>
                                                                <div className="tyn-video-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         width="16" height="16" fill="currentColor"
                                                                ...
                                                                <div className="tyn-media-group">
                                                                    <div
                                                                        ...
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                             ...
                                                                             viewBox="0 0 16 16">
                                                                            <path fillRule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2H6v-1h6a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5L14 4.5ZM1.113 14.82.8 15.85H0l1.342-3.999h.926l1.336 3.999h-.841l-.314-1.028H1.113Zm1.178-.588-.49-1.617h-.034l-.49 1.617h1.014Zm2.425-2.382v3.999h-.791V11.85h.79Z"></path>
                                                                        </svg>
                                                                    </div>
                                                                    <div className="tyn-media-col">
                                    ...
                                    <div className="tab-pane show active" id="chat-options" tabIndex="0"
                                        ...
                                        <div className="tyn-aside-row py-0">
                                            <ul className="nav nav-tabs nav-tabs-line" role="tablist">
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link active" data-bs-toggle="tab"
                                                            data-bs-target="#chat-options-customize" type="button"
                                                            aria-selected="true" role="tab"> Customize
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button className="nav-link" data-bs-toggle="tab"
                                                            data-bs-target="#chat-options-manage" type="button"
                                                            aria-selected="false" tabIndex="-1" role="tab"> Manage
                                                    </button>
                                                </li>
                                            </ul>
                                        </div>
                                                            ...
                                                            <ul className="tyn-media-list gap gap-3">
                                                                <li>
                                                                    <div className="tyn-media-group">
                                                                        ...
                                                                        <div className="tyn-media-col">
                                                                            <div className="tyn-media-row">
                                                                                <h6 className="name">Jasmine
                                                                                    Thompson</h6>
                                                                            </div>
                                                                            <div className="tyn-media-row has-dot-sap">
                                                                                <span
                                                                                    className="meta">og : Jasmine</span>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <li>
                                                                    <div className="tyn-media-group">
                                                                        ...
                                                                        <div className="tyn-media-col">
                                                                            <div className="tyn-media-row">
                                                                                <h6 className="name">Konstantin
                                                                                    Frank</h6>
                                                                            </div>
                                                                            <div className="tyn-media-row has-dot-sap">
                                                                                <span
                                                                                    className="meta">og : konstatin nk</span>
                                                                            </div>
                                                                        </div>
                                                                        <div className="tyn-media-option">
                                                                            <ul className="tyn-media-option-list">
                                                            ...
                                                            <a href="#" className="tyn-file">
                                                                <div className="tyn-media-group">
                                                                    ...
                                                                    <div className="tyn-media-col">
                                                                        ...
                                                                        <div className="meta">Frank will no longer be in
                                                                            your contact.
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <a href="#" className="tyn-file">
                                                                <div className="tyn-media-group">
                                                                    ...
                                                                    <div className="tyn-media-col">
                                                                        ...
                                                                        <div className="meta">Give feedback on the
                                                                            conversation
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                <div className="simplebar-placeholder h-[893px]"/>
            </div>
            <div className="simplebar-track simplebar-vertical">
                <div className="simplebar-scrollbar h-[861px] transform-[translate3d(0px, 0px, 0px)] block"/>
            </div>
        </div>
    )
}
