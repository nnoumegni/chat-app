...
export const AsideRight = () => {
    ...
    const activeCls = showAside ? 'show-aside' : '';
    const overlayCls = showAside ? 'active' : '';

    useEffect(() => {}, []);

    return (
        <>
            <div className={'tyn-overlay js-toggle-chat-options ' + overlayCls} onClick={() => setShowAside({showAside: false})}/>
            <div className={'tyn-chat-content-aside ' + activeCls} id="tynChatAside" data-simplebar>
                ...
                <div className="tab-content">
                            ...
                            <div className="tab-content">
                                <div className="tab-pane show active" id="chat-media-images" tabIndex={0}>
                                    <div className="row g-3">
                                        <div className="col-4">
                                            <a href="assets/images/gallery/chat/1.jpg" className="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="assets/images/gallery/chat/thumb-1.jpg" className="tyn-image" alt=""/>
                                            </a>
                                        </div>
                                        <div className="col-4">
                                            <a href="assets/images/gallery/chat/2.jpg" className="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="assets/images/gallery/chat/thumb-2.jpg" className="tyn-image" alt=""/>
                                            </a>
                                        </div>
                                        <div className="col-4">
                                            <a href="assets/images/gallery/chat/3.jpg" className="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="assets/images/gallery/chat/thumb-3.jpg" className="tyn-image" alt=""/>
                                            </a>
                                        </div>
                                        <div className="col-4">
                                            <a href="assets/images/gallery/chat/4.jpg" className="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="assets/images/gallery/chat/thumb-4.jpg" className="tyn-image" alt=""/>
                                            </a>
                                        </div>
                                        <div className="col-4">
                                            <a href="assets/images/gallery/chat/5.jpg" className="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="assets/images/gallery/chat/thumb-5.jpg" className="tyn-image" alt=""/>
                                            </a>
                                        </div>
                                        <div className="col-4">
                                            <a href="assets/images/gallery/chat/6.jpg" className="glightbox tyn-thumb" data-gallery="media-photo">
                                ...
                                <div className="tab-pane" id="chat-media-videos" tabIndex={0}>
                                    <div className="row g-3">
                                        <div className="col-6">
                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" className="glightbox tyn-video" data-gallery="media-video">
                                            ...
                                            <a href="#" className="tyn-file">
                                                <div className="tyn-media-group">
                                                    <div className="tyn-media tyn-size-lg text-bg-light">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-filetype-ai" viewBox="0 0 16 16">
                                                            <path fillRule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2H6v-1h6a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5L14 4.5ZM1.113 14.82.8 15.85H0l1.342-3.999h.926l1.336 3.999h-.841l-.314-1.028H1.113Zm1.178-.588-.49-1.617h-.034l-.49 1.617h1.014Zm2.425-2.382v3.999h-.791V11.85h.79Z" />
                                                        </svg>
                                                    </div>
                                                    <div className="tyn-media-col">
                                            ...
                                            <a href="#" className="tyn-file">
                                                <div className="tyn-media-group">
                                                    <div className="tyn-media tyn-size-lg text-bg-light">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-filetype-mdx" viewBox="0 0 16 16">
                    ...
                    <div className="tab-pane show active" id="chat-options" tabIndex={0}>
                        <div className="tyn-aside-row py-0">
                            <ul className="nav nav-tabs nav-tabs-line">
                                <li className="nav-item">
                                    <button className="nav-link active" data-bs-toggle="tab" data-bs-target="#chat-options-customize" type="button"> Customize </button>
                                </li>
                                <li className="nav-item">
                                    <button className="nav-link" data-bs-toggle="tab" data-bs-target="#chat-options-manage" type="button"> Manage </button>
                                </li>
                            </ul>
                        </div>
                        <div className="tyn-aside-row">
